        ...
        <div class="col-lg-8 col-xl-8">
          <div class="post-single">
            <div class="post-thumb">
              <img
                src="{{ asset('frontend/') }}/assets/images/blog-lg1.jpg"
                alt=""
                class="img-fluid"
              />
            </div>
            <div class="single-post-content">
              ...
              <p>
                ...
                dolores debitis numquam, reprehenderit eum consequuntur cum,
                quam nesciunt esse tenetur architecto molestiae adipisci.
              </p>
              <p>
              ...
              <blockquote>
                ...
                time.its called professionalism. Build your site with care.
              ...
              <p>
                ...
                metrics are useful in helping you get to know your audience.
              </p>
              <ul>
            ...
            <div class="post-single-author mb-5">
              <div class="author-img">
                <img
                  src="{{ asset('frontend/') }}/assets/images/author.jpg"
                  alt=""
                  class="img-fluid"
                />
              </div>
              <div class="author-info">
                ...
                <p>
                  ...
                  mollitia totam ipsam obcaecati, iusto alias reprehenderit
                  tempora placeat voluptates eligendi.
                </p>
              </div>
            </div>
            {/*  Comment start */}
            <div class="comments common-form">
              ...
              <div class="comment-box">
                <div class="comment-avatar">
                  <img
                    src="{{ asset('frontend/') }}/assets/images/user.jpg"
                    class="me-3"
                    alt="..."
                  />
                </div>
              ...
              <div class="recent-posts">
                <div class="single-latest-post">
                  <div class="widget-thumb">
                    <a href="blog-single.html">
                      <img
                        src="{{ asset('frontend/') }}/assets/images/sm3.png"
                        alt=""
                        class="img-fluid"
                      />
                    </a>
                ...
                <div class="single-latest-post">
                  <div class="widget-thumb">
                    <a href="blog-single.html">
                      <img
                        src="{{ asset('frontend/') }}/assets/images/sm2.png"
                        alt=""
                        class="img-fluid"
                      />
                    </a>
