      ...
      <div class="row">
        <div class="col-lg-8 col-xl-8">
          <div class="course-header-wrapper mb-0 bg-transparent">
            <h1 class="mb-3">Mastering PHP from zero to hero</h1>
            <p>
              ...
              <ul class="inline-list list-info">
                <li>
                  <div class="course-author">
                    <img
                      src="{{ asset('frontend/') }}/assets/images/course-author.png"
                      alt="#"
                    />
                    Madge Alvarez
                  </div>
          ...
          <div class="course-sidebar course-sidebar-3 mt-5 mt-lg-0">
            <div class="course-widget course-details-info ">
              <div class="course-thumbnail">
                <img
                  src="{{ asset('frontend/') }}/assets/images/img_02.jpg"
                  alt=""
              ...
              <div class="course-sidebar-details">
                ...
                <div class="buy-btn">
                  <button class="button button-enroll-course btn btn-main rounded">
                    <i class="fa-solid fa-cart-shopping"></i> Enroll
                    Course
                  </button>
                </div>
